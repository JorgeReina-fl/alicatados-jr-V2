                ...
                <div className="container mx-auto px-4">
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            ...
                            <article key={idx} className="bg-secondary-900 p-8 hover:shadow-xl hover:shadow-accent-500/10 transition-all border border-secondary-800 hover:border-accent-500/30">
